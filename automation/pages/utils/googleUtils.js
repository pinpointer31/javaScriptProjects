...
module.exports = function(browser) {
    ...
    this.openBrowser = function (){
        ...
        google.assert.visible('@googleSearchInput');
    };
    ...
    this.searchForInterstellar = function (){
        google.setValue('@googleSearchInput', 'interstellar', ()=>{
            browser.verify.ok(true, 'Value could be set to @googleSearchInput');
        });
        google.waitForElementVisible('@searchButton', 2000);
        google.click('@searchButton', () => {
            google.verify.ok(true, 'Click is works on searchButton');
        });
        google.waitForElementVisible('@movieLink', 2000);
        google.assert.visible('@movieLink');
        google.click('@movieLink', () =>{
